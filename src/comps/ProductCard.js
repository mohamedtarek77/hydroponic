  ...
  return (
    ...
    <div className="flex   md:flex-row flex-col sm:justify-between bg-slate-300   px-10 py-12 rounded-[20px]   w-full  md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
      <div className="flex flex-col  text-secondary ">
        <h4 className="font-poppins font-semibold sm:text-[30px]  text-[20px]   sm:leading-[32px]  leading-[22px] ">
          <span className="text-gradient"> {name}</span>
        </h4>
        <p className="font-poppins font-normal h-auto md:w-[800px] w-[300px] sm:text-[18px] text-[12px]  sm:leading-[32.4px] leading-[22.4px] sm:my-10 my-5  px-5 text-secondary">
          {content}
        </p>
      </div>
