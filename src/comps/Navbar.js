...
import { close, logo, menu ,colorLogoNoBackground,colorLogoWithBackground ,logoColor,logoColorNoBackground} from "../assets";
...
const Navbar = () => {
  ...
  return (
    <nav className=" w-full flex py-6 justify-between items-center navbar">
      ...
      <Image src={logoColorNoBackground} alt="Ast-media-logo" 
        ...
        {navLinks.map((nav, index) => (
          <li
            ...
            className={`font-poppins  font-semibold cursor-pointer text-[16px] ${
              active === nav.title ? "text-secondary underline underline-offset-4" : " text-secondary "
            } 
