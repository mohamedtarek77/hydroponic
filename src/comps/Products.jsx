        ...
        <div className={`flex md:flex-row flex-col ${styles.paddingY} `}>
          ...
          >
            <div className="flex flex-row justify-between items-center w-full  text-secondary">
              <h1 className="flex-1 font-poppins font-semibold ss:text-[70px]  text-[22px]   ss:leading-[100.8px] leading-[75px]">
                Best Products
            ...
            <h3 className={`${styles.paragraph}  w-full mt-5  text-Third`}>
